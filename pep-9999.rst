...
3. The virtualenv-specific files are read
...
There is no way to _remove_ data from the configuration which has once been defined. However, repositories can be disabled using the ``enable`` attribute.
