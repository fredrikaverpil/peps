...
This PEP standardizes configuration of Python package indexes.

Initially, this standard is limited to support package indexes which are deployments of
Warehouse [1]_ (like PyPI.org [2]_) but can in the future be extended to support other
types of package indexes.
...
Shadowing implies "fallback" and the instructions "Use package from this index" implies
this takes priority. This can be cause for a fair amount of reasoning issues and can
also have concerns around PEP-610 [3]_ and lock files. With shadowing, behavior of
downstream tools are dictated.
